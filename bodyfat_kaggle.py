...
# Fonte https://www.kaggle.com/datasets/fedesoriano/body-fat-prediction-dataset
...
#%% Matriz de descritivas transposta
...
#%% Matriz de correlação com variação de cor pelo seaborn
...
ax = sns.barplot(x=tabela_eigen.index, y=tabela_eigen['Variância'], data=tabela_eigen, color='#3498db')
...
#%% Ajuste na tabela para printar o texto no gráfico

tabela_cargas = tabela_cargas.reset_index()

#%% Gráfico das cargas fatoriais dos fatores principais
...
#%% Gráfico das cargas fatoriais dos 3 fatores

import plotly.express as px
import plotly.io as pio
pio.renderers.default='browser'

fig = px.scatter_3d(tabela_cargas, x='Fator 1', y='Fator 2', z="Fator 3", text="index")
